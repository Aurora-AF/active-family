...
<head>
    ...
    <link href="http://localhost:8888/active_v3/Information_page/style/menu.css" type="text/css" rel="stylesheet">
    <script type="text/javascript" src="http://localhost:8888/active_v3/Information_page/js/jquery.js"></script>
    <script type="text/javascript" src="http://localhost:8888/active_v3/Information_page/js/jquery.dimensions.js"></script>
    <script type="text/javascript" src="http://localhost:8888/active_v3/Information_page/js/jquery.accordion.js"></script>
